...
@WebServlet("/PropertyPurchaseServlet")
public class PropertyPurchaseServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = PropertyDBUtil.UpdatePurchasedProperty(propertyID, buyerNIC);
		...
		IStrue = PropertyDBUtil.InsertPurchasedProperty(id, buyerNIC);
