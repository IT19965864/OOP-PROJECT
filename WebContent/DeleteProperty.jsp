...
<body bgcolor="DarkSlateGray" style="background-image:url('vin.jpg') ;opacity: 0.9; background-repeat: no-repeat;background-size: 100% 12cm;background-position-y: 17PX" >
		...
		<ul id="b1">
			...
			<li><a href="home.html" class="a1">HOME</a></li>
		...
		<hr class="a4">
	<form action="deletePermanent" method="post">	
		<c:forEach var = "dl" items= "${DeleteDetails}">
		<table style="width:30% ; background-color:gray">
		
			<tr>
				<td>PROPERTY ID </td>
				<td><input type="text" name= "pid" value = "${dl.propertyID}" readonly></td>
			</tr>
			<tr>
				<td>OWNER ID </td>
				<td><input type="text" name="oid" value= "${dl.ownerID}" readonly></td>
			</tr>
			<tr>
				<td>LOCATION </td>
				<td><input type="text" name="loc" value="${dl.location}" readonly></td>
			</tr>
			<tr>
				<td>AREA(IN PERCH) </td>
				<td><input type="text" name="area" value="${dl.area}" readonly></td>
			</tr>
			<tr>
				<td>VALUE(PER PERCH)</td>
				<td><input type ="text" name="val" value = "${dl.value}" readonly></td>
			</tr>
			<tr>
				<td>CATEGORY </td>
				<td><input type ="text" name ="cat" value ="${dl.category}" readonly></td>
			</tr>
			<tr>
				<td>TYPE</td>
				<td><input type = "text" name ="type" value = "${dl.type}" readonly></td>
			</tr>
		</table>
		<br>
		</c:forEach>
