...
<title>Sold/Reserved Property</title>
...
<body bgcolor="DarkSlateGray" style="background-image:url('vin.jpg') ;opacity: 0.9; background-repeat: no-repeat;background-size: 100% 15cm;background-position-y: 17PX">
	
	<ul id="b1">
			<li class="a2"><img src="batch.png" width="260px" height="100px" class ="a19" >
			<li><a href="Home.jsp" class="a1">HOME</a></li>
			<li><a href="Log.jsp" class="a0">LOG IN</a></li>
	...
	<c:forEach var = "so" items= "${soldDetails}">
	<table style="width:30% ; background-color:gray">
	
		<tr>
			<td>PROPERTY ID </td>
			<td><b>${so.propertyid}</b></td>
		</tr>
		<tr>
			<td>BUYER ID </td>
			<td><b>${so.buyernic}</b></td>
		</tr>
		<tr>
			<td>TYPE </td>
			<td><b>${so.type}</b></td>
