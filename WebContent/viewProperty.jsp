...
<body bgcolor="DarkSlateGray" style="background-image:url('vin.jpg') ;opacity: 0.9; background-repeat: no-repeat;background-size: 100% 40cm;background-position-y: 17PX" >
	...
	<c:forEach var = "pr" items= "${prDetails}">
